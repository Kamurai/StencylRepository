...
private var BehaviorList:ByteArray
		...
		public var r1_0:Bitmap;
public var r3_0:Bitmap;
public var r4_0:Bitmap;
public var r6_0:Bitmap;
public var r8_0:Bitmap;
public var r10_0:Bitmap;
...
private var scene0b:ByteArray;
		...
		public function init(assets:Assets, numLeft:int = 0, state:GameState=null):void
		{
			...
			if(remote)
			{
				loadExternalResource("C:/House/Programming/Stencyl/stencylworks/preview/game/game.xml", "GameXML");
loadExternalResource("C:/House/Programming/Stencyl/stencylworks/preview/game/scenes.xml", "SceneList");
loadExternalResource("C:/House/Programming/Stencyl/stencylworks/preview/game/behaviors.xml", "BehaviorList");
loadExternalResource("C:/House/Programming/Stencyl/stencylworks/preview/game/resources.xml", "ResourceList");
loadExternalResource("C:/House/Programming/Stencyl/stencylworks/preview/game/scenes/0.xml", "scene0");
loadExternalResource("C:/House/Programming/Stencyl/stencylworks/preview/game/scenes/0.scn", "scene0b");
loadImage("C:/House/Programming/Stencyl/stencylworks/preview/game/resources/1-0.png", "r1_0");
loadImage("C:/House/Programming/Stencyl/stencylworks/preview/game/resources/3-0.png", "r3_0");
loadImage("C:/House/Programming/Stencyl/stencylworks/preview/game/resources/4-0.png", "r4_0");
loadImage("C:/House/Programming/Stencyl/stencylworks/preview/game/resources/6-0.png", "r6_0");
loadImage("C:/House/Programming/Stencyl/stencylworks/preview/game/resources/8-0.png", "r8_0");
loadImage("C:/House/Programming/Stencyl/stencylworks/preview/game/resources/10-0.png", "r10_0");
		...
		{
			a.resourceAssets["1-0.png"] = r1_0;
a.resourceAssets["3-0.png"] = r3_0;
a.resourceAssets["4-0.png"] = r4_0;
a.resourceAssets["6-0.png"] = r6_0;
a.resourceAssets["8-0.png"] = r8_0;
a.resourceAssets["10-0.png"] = r10_0;
