...
public var _Speed:Number = 0.0;
    ...
    {
                  if((actor.getY() < (getScreenHeight() / 2)))
{
            actor.setXVelocity(randomInt(Math.floor(-20), Math.floor(20)));
            actor.setYVelocity((randomInt(Math.floor(0), Math.floor(20)) * -1));
}

        else
{
            actor.setXVelocity(randomInt(Math.floor(-20), Math.floor(20)));
            actor.setYVelocity(randomInt(Math.floor(0), Math.floor(20)));
}
...
{
                    actor.setXVelocity(((actor.getX() - (getMouseX() - _xDiff)) * -10));
}
...
{
                    actor.setYVelocity(((actor.getY() - (getMouseY() - _yDiff)) * -10));
}
